...
func NewRemoteAgent(chain consensus.ChainReaderCtt, engine consensus.EngineCtt) *RemoteAgent {
	return &RemoteAgent{
		chain:    chain,
		engine:   engine,
...
func (a *RemoteAgent) GetWork() ([3]string, error) {
	...
	if a.currentWork != nil {
		...
		res[0] = block.HashNoBft().Hex()
		//seedHash := elephanthash.SeedHash(block.NumberU64())
		res[1] = common.BytesToHash([]byte("elephant-test")).Hex()
		...
		a.work[block.HashNoBft()] = a.currentWork
		return res, nil
	}
...
func (a *RemoteAgent) SubmitWork(nonce types.BlockNonce, mixDigest, hash common.Hash) bool {
	...
	//if err := a.engine.VerifySeal(a.chain, result, false); err != nil {
	...
	a.returnCh <- &Result{work, block, nil}
	delete(a.work, hash)
